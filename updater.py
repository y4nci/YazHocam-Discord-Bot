...
def getarchive():
    ...
    for link in links:
        ...
        for text in texts:
            if text.text in ["Kaynakça", "KAYNAKÇA", "Kaynakça:", "KAYNAKÇA:", " Bir dahaki sefere yorum yaptığımda kullanılmak üzere adımı, e-posta adresimi ve web site adresimi bu tarayıcıya kaydet."]:
                break
